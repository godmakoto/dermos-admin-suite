...
export const mockOrders: Order[] = [
  {
    ...
    items: [
      { id: "1", productId: "1", productName: "Effaclar Duo+ Crema", quantity: 2, price: 89.90 },
      { id: "2", productId: "2", productName: "Sensibio H2O Agua Micelar", quantity: 1, price: 65.00 },
    ],
    subtotal: 244.80,
    discount: 0,
    total: 244.80,
  ...
  },
  {
    ...
    items: [
      { id: "3", productId: "3", productName: "Crema Hidratante Facial", quantity: 3, price: 54.50 },
    ],
    subtotal: 163.50,
    discount: 16.35,
    total: 147.15,
  ...
  },
  {
    ...
    items: [
      { id: "4", productId: "1", productName: "Effaclar Duo+ Crema", quantity: 1, price: 89.90 },
    ],
    subtotal: 89.90,
    discount: 0,
    total: 89.90,
